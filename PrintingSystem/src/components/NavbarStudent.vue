  ...
  <div class="max-w-screen-xl flex flex-wrap justify-between items-center mx-auto p-4">
    ...
    <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user" style="margin-right: 250px;">
      <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white">
        ...
        <li style="margin-right: 20px;">
          <router-link to="/print" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-500 md:p-0">Print</router-link>
        </li>
        <li style="margin-right: 20px;">
          <router-link to="/orders" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-500 md:p-0">Orders</router-link>
        </li>
        <li>
