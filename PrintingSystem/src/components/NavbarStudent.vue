  ...
  <div class="max-w-screen-xl flex flex-wrap justify-between items-center mx-auto p-4">
    ...
    <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      ...
      <div id="dropdownNotification" class="z-20 hidden w-full max-w-sm bg-white divide-y divide-gray-100 rounded-lg shadow" aria-labelledby="dropdownNotificationButton">
        ...
        <div class="divide-y divide-gray-100">
          ...
          <a class="flex px-4 py-3 hover:bg-gray-100">
            ...
            <div class="w-full ps-3">
                <div class="text-gray-500 text-sm mb-1.5">New announcement from <span class="font-semibold text-gray-900">Admins</span>: "Printer #2 has it’s ink refilled."</div>
          ...
          <a class="flex px-4 py-3 hover:bg-gray-100">
            ...
            <div class="w-full ps-3">
                <div class="text-gray-500 text-sm mb-1.5">New announcement from <span class="font-semibold text-gray-900">Admins</span>: "Printer #2 has no ink left."</div>
          ...
          <a class="flex px-4 py-3 hover:bg-gray-100">
            ...
            <div class="w-full ps-3">
                <div class="text-gray-500 text-sm mb-1.5">New announcement from <span class="font-semibold text-gray-900">Admins</span>: "Printer #1 has it’s paper refilled."</div>
                <div class="text-xs text-blue-600">18 hours ago</div>
            </div>
          </a>
          ...
          <a class="flex px-4 py-3 hover:bg-gray-100">
            ...
            <div class="w-full ps-3">
              <div class="text-gray-500 text-sm mb-1.5">New announcement from <span class="font-semibold text-gray-900">Admins</span>: "Printer #1 has no paper left."</div>
        ...
        <router-link to="#" class="block py-2 text-sm font-medium text-center text-gray-900 rounded-b-lg bg-gray-50 hover:bg-gray-100">
    ...
    <!-- Begin user profile -->
    <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      <button type="button" class="flex text-sm bg-transparent rounded-full md:me-0 focus:ring-4 focus:ring-gray-300" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
        <span class="sr-only">Open user menu</span>
        <img class="w-8 h-8 rounded-full" src="/images/profile.png" alt="user photo">
      </button>
    
      <!-- Dropdown menu -->
      <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow" id="user-dropdown" style="font-family: 'Comfortaa'; width: 300px;">
        <div class="px-4 py-3 flex items-center">
          ...
          <div>
            ...
            <span class="block text-sm text-yellow-500 truncate">Student</span>
          </div>
        </div>
    ...
    <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      <button type="button" class="text-blue-500 border border-blue-500 hover:bg-blue-500 hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-semibold rounded-lg text-sm px-4 py-2 text-center">Get more papers</button>
    ...
    <!-- Begin navlinks -->
    <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user" style="margin-right: 250px;">
      <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white">
        ...
        <li style="margin-right: 20px;">
          <router-link to="#" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-500 md:p-0">Print</router-link>
        </li>
        <li style="margin-right: 20px;">
          <router-link to="#" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-500 md:p-0">Orders</router-link>
        </li>
        <li>
          <router-link to="#" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-500 md:p-0">Contribute</router-link>
        </li>
